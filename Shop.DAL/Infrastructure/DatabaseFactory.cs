namespace Shop.DAL.Infrastructure
{
    ...
    public class DatabaseFactory : Disposable, IDatabaseFactory
    {
        ...
        public DbContext Get()
        {
            if (this._dataContext == null) this._dataContext = new DbContext(this._connectionString);
            this._dataContext.Database.ExecuteSqlCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;");
