namespace Library.Extensions
{
    ...
    public static class DataTableExtension
    {
        ...
        public static List<T> ToList<T>(this DataTable dataTable) where T : new()
        {
            ...
            if (dataTable.Rows == null || dataTable.Rows.Count < 1) return dataList;
                ...
                foreach (var dtField in dtlFieldNames)
                {
                    if (dataRow[dtField.Name] != null)
                    {
                        ...
                        if (field != null)
                        {
                            ...
                            {
                                if (dataRow[dtField.Name].ToString().Trim() != "")
                            ...
                            else if (propertyInfos.PropertyType == typeof(double) || propertyInfos.PropertyType == typeof(double?))
                            {
                                if (dataRow[dtField.Name].ToString().Trim() != "")
                                    propertyInfos.SetValue
                                    (classObj, Convert.ToDouble(dataRow[dtField.Name]), null);
                            }
                            ...
                            else if (propertyInfos.PropertyType == typeof(bool) || propertyInfos.PropertyType == typeof(bool?))
                            {

                                if (dataRow[dtField.Name].ToString().Trim() != "")
                                {
                                    var value = dataRow[dtField.Name].ToString().Trim();
                                    if (value.ToLower() == "true" || value.ToLower() == "1")
                                        propertyInfos.SetValue(classObj, true, null);
                                    else propertyInfos.SetValue(classObj, false, null);
                                }
                            }
                        }
                    }
